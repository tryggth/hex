/* ============================================================================
 * HEX MCTS PWA — COMPLETE JAVASCRIPT SOURCE CODE
 * ============================================================================
 * This single file aggregates all JavaScript source code for the Hex MCTS app.
 *
 * Contents:
 *   SECTION 1: Core Application Logic & Engine (hex-pwa/app.js)
 *   SECTION 2: Service Worker Cache Management (hex-pwa/sw.js)
 *   SECTION 3: Inline Service Worker Registration (hex-pwa/index.html script)
 * ============================================================================
 */

/* ============================================================================
 * SECTION 1: hex-pwa/app.js
 * Core Game Engine, Union-Find Win Detection, MCTS Algorithm, Nash Rollouts,
 * Logarithmic Factorial Math, Heatmap Rendering, and UI Event Handlers.
 * ============================================================================
 */
'use strict';
...
/* ============================================================================
 * SECTION 2: hex-pwa/sw.js
 * Progressive Web App Service Worker with self-updating cache strategy.
 * ============================================================================
 */
...
/* ============================================================================
 * SECTION 3: hex-pwa/index.html (Inline Service Worker Registration Script)
 * Registers sw.js and triggers an immediate reload on controller change.
 * ============================================================================
 */
